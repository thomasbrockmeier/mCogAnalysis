...
ratings1_noCheck_final(5, 4) = min(nOut1(1, :));
ratings1_noCheck_final(5, 5) = max(nOut1(1, :));
...
ratings1_fullConc_final(5, 4) = min(nOut1(2, :));
ratings1_fullConc_final(5, 5) = max(nOut1(2, :));
...
ratings1_dsConc_final(5, 4) = min(nOut1(3, :));
ratings1_dsConc_final(5, 5) = max(nOut1(3, :));
...
ratings1_adjConc_final(5, 4) = min(nOut1(4, :));
ratings1_adjConc_final(5, 5) = max(nOut1(4, :));
...
ratings2_noCheck_final(5, 4) = min(nOut2(1, :));
ratings2_noCheck_final(5, 5) = max(nOut2(1, :));
...
ratings2_fullConc_final(5, 4) = min(nOut2(2, :));
ratings2_fullConc_final(5, 5) = max(nOut2(2, :));
...
ratings2_dsConc_final(5, 4) = min(nOut2(3, :));
ratings2_dsConc_final(5, 5) = max(nOut2(3, :));
...
ratings2_adjConc_final(5, 4) = min(nOut2(4, :));
ratings2_adjConc_final(5, 5) = max(nOut2(4, :));
